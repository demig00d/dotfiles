...
# pnpm
set -gx PNPM_HOME "/Users/demigood/Library/pnpm"
if not string match -q -- $PNPM_HOME $PATH
  set -gx PATH "$PNPM_HOME" $PATH
end
# pnpm end
abbr -a -- py python3 # imported from a universal variable, see `help abbr`
abbr -a -- vim nvim # imported from a universal variable, see `help abbr`
abbr -a -- g git
abbr -a -- ga 'git add'
